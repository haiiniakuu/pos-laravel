        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <input type="radio" id="is_active" name="is_active" value="1" {{ $edit->is_active == 1 ? 'checked':'' }}> Publish
                    <input type="radio" id="is_active" name="is_active" value="0" {{ $edit->is_active == 0 ? 'checked':'' }}> Draft
                </div>
            </div>
            <div class="col-sm-6">
                <div class="mb-3">
