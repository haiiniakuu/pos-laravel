...
class ProfileController extends Controller
{
    ...
    public function changePassword(Request $request)
    {
        ...
        alert()->success('Success', 'The change passsword success!!');
        return back();
    }
    ...
    public function changeProfile(Request $request)
    {
        ...
        try {
            UserDetail::upsert(
                ...
                ['user_id'],
                ['phone', 'about', 'company', 'address','photo', 'job']
            );

            alert()->success('Succeess', 'Edit profile  success');
